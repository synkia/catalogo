...
echo -e "${BLUE}=================================${NC}"
echo -e "${GREEN}Iniciando Catalogo ML no servidor${NC}"
echo -e "${BLUE}=================================${NC}"
...
# Salvar os PIDs para uso posterior
echo "${BACKEND_PID} ${FRONTEND_PID}" > /workspace/catalogo/running.pid

echo -e "${GREEN}Serviços iniciados e rodando em segundo plano.${NC}"
echo -e "${YELLOW}Para verificar o status, execute:${NC} ./check-external.sh"